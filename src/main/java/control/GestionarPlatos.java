...
public class GestionarPlatos {
    ...
    // Al poner el BufferedWriter dentro del paréntesis del try, 
    // Java se encarga de HACER EL CIERRE Y GUARDADO automático.
    try (BufferedWriter bw = new BufferedWriter(new FileWriter(archivo, false))) {
        ...
        // No necesitas bw.close(), el try lo hace por ti al terminar la llave }
    } catch (IOException e) {
        e.printStackTrace(); // Revisa si sale algún error aquí en la consola de NetBeans
    }
}
