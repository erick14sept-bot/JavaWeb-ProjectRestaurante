...
<%
    ...
    if (listaP == null) {
        control.GestionarPlatos gp = new control.GestionarPlatos();
        listaP = gp.getLista();
        session.setAttribute("sesionPlatos", listaP);
    }
%>
            ...
            <tbody>
                ...
                %>
                    <tr>
                        ...
                        <td class="fw-bold text-white"><%= p.getNombrePlato() %></td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="PlatoServlet?accion=eliminar&codigo=<%= p.getCodigoPlato() %>" 
